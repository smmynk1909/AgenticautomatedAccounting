"""mcp-erp process entrypoint: `uvicorn awp_mcp_erp.main:app --host 0.0.0.0 --port 8000`."""
...
_audit_mcp = MCP(
    ...
    principal_jwt_provider=lambda: mint_service_jwt("erp-service", ["audit.write"]),
)
_audit_sink = RemoteAuditSink(_audit_mcp)

app: FastAPI = build_asgi_app(make_erp_server(_uow, _redis, _audit_sink))
