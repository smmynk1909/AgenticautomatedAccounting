"""mcp-comms process entrypoint: `uvicorn awp_mcp_comms.main:app --host 0.0.0.0 --port 8000`."""
...
_audit_mcp = MCP(
    ...
    principal_jwt_provider=lambda: mint_service_jwt("comms-service", ["audit.write"]),
)
_audit_sink = RemoteAuditSink(_audit_mcp)

app: FastAPI = build_asgi_app(make_comms_server(_uow, _redis, _audit_sink))
